							...
							<div class="pull-right hidden-xs">
								<div class="header-login-url">
									...
									<div class="custom_topbar_menu">
										<div class="search_container menu_items">
											<span class=""><i class="fa fa-search" aria-hidden="true" title="search"></i></span>
											<div class="search_wrapper item_wrapper">
												<?php echo do_shortcode( '[ivory-search id="16167" title="Menu Search Form"]' ); ?>
											</div>
										</div>
										<div class="social_icons menu_items">											
											<ul class="social-media">
												<li><a href="#" target="_blank"><i class="fa fa-facebook-square" aria-hidden="true" title="facebook"></i></a></li>
												<li><a href="#" target="_blank"><i class="fa fa-instagram" aria-hidden="true" title="instagram"></i></a></li>
												<li><a href="#" target="_blank"><i class="fa fa-linkedin-square" aria-hidden="true" title="linkedin"></i></a></li>
												<li></li>
											</ul>											
										</div>
										<div class="stm-shareble" >
								                <a href="#" style="padding:0px;" class="btn btn-share <?php if(stm_is_aircrafts()) echo 'heading-font'; ?>">
										...
										<div class="weather_icon menu_items">
											<span class=""><i class="fa fa-cloud" aria-hidden="true" title="weather"></i></span>
											<div class="outer-weather item_wrapper">
												<h4 class="weather-title">TODAY'S RIDE FORECAST</h4>
												<div class="weather_box">
													<?php echo do_shortcode( '[widget id="sp_location_weather_widget_content-2"]' ); ?>
												</div>
											</div>											
										</div>
										<span class="vertical-divider"></span>
										<div class="account_icon menu_items">
											<span class="account_menu"><i class="fa fa-user" title="account"></i></span>
											<div class="account-wrapper item_wrapper">
												<?php if(is_user_logged_in()): ?>
													<div class="btn_container container_login">
														<a class="logout-link 222 custom_btn btn_reg btn_account" href="<?php get_author_link( true, get_current_user_id()); ?>" title="<?php _e('My Account', 'motors'); ?>">
															<i class="fa fa-icon-stm_icon_user"></i>
									...
									<?php /* ?><?php if(is_user_logged_in()): ?>
										<a class="logout-link 222 " style="margin-right: 10px;" href="<?php get_author_link( true, get_current_user_id()); ?>" title="<?php _e('My Account', 'motors'); ?>">
											<i class="fa fa-icon-stm_icon_user"></i>
											<?php _e('My Account', 'motors'); ?>
										</a>
