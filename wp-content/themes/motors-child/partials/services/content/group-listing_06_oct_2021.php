                        ...
                        <div class="content">
                            ...
                            <div class="meta-middle contentblockpart">
								<div class="meta-middle titleblockpart">
									...
									<?php if($group_member){ ?>
									<div class="stm-group-size titleblocktop">
										<div class="inner">
								...
								<a target="_blank" href="<?php echo get_permalink($group_id); ?>">
									<div class="meta-right-unit-inner">
										<div class="name">
											...
											<img src="<?php echo get_home_url(); ?>/wp-content/uploads/2021/09/4-2-harley-davidson-logo-white.png">
										</div>
									</div>
								</a>
							</div>
                            ...
                            <div class="meta-bottom">
								...
								<div class="single-car-actions">
                                	<div class="panel-group acc_container">
										<div class="acc_inner">
										<?php
											$category_group = get_field('category_group',$group_id);
