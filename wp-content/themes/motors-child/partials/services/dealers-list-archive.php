...
<?php 
        ...
        //echo "+++".count($none_dealer_users_prelist)."<br>";
			...
			$total_count_stm_u = count($none_dealer_users);
    ...
    <div class="col-md-3 col-sm-12 classic-filter-row sidebar-sm-mg-bt <?php echo esc_attr($sidebar_pos['sidebar']); ?>" style="margin-top: -20px;">
		...
		<div class="count_list_n">
			<div class="row">
				...
				<div class="col-xs-3 search-div"><span class="text_after_counter">Dealers</span></div>
			</div>
		</div>
		<form  method="get" action="/dealers-list/" id="dealerships" class="dealerships">
        ...
        <div class="stm-inventory-sidebar dealerships-sidebar 888">
										...
										<div class="stm-accordion-inner">
											<div class="tree_main">
												<label class="stm-option-label" style="display: block;">
													<div class="checker"><span><input type="checkbox" class="chk_filter_removeall chk_filter_condition" data-class="chk_all_filter_condition" name="service_category[]" value="20155"></span></div>
													<span>New</span>
												</label>
												<label class="stm-option-label" style="display: block;">
													<div class="checker"><span><input type="checkbox" class="chk_filter_removeall chk_filter_condition" data-class="chk_all_filter_condition" name="service_category[]" value="20155"></span></div>
						...
						<div class="stm-accordion-single-unit stm-listing-directory-checkboxes stm-one_col stm-ajax-checkbox-instant">
							...
							<a class="title <?php echo $dealercategory; ?>" data-toggle="collapse" href="#accordion-dealerships-advance" aria-expanded="false">
								<h5> Advanced Search</h5>
								<span class="minus"></span>
							</a>
							<div class="stm-accordion-content">
								<div class="collapse content <?php echo $dealercategory2;?>" id="accordion-dealerships-advance">
									<div class="stm-accordion-content-wrapper stm-accordion-content-padded">
										<div class="stm-accordion-inner">
											<div class="tree_main">
												<label class="stm-option-label" style="display: block;">
												...
												<label class="stm-option-label" style="display: block;">
													<div class="checker"><span><input type="checkbox" class="chk_filter_removeall chk_filter_condition" data-class="chk_all_filter_condition" name="service_category[]" value="20155"></span></div>
													<span>Financialing Arranged</span>
												</label>
												<label class="stm-option-label" style="display: block;">
													<div class="checker"><span><input type="checkbox" class="chk_filter_removeall chk_filter_condition" data-class="chk_all_filter_condition" name="service_category[]" value="20155"></span></div>
            ...
            <form  method="get" action="/dealers-list/">
                    ...
                    <div class="row row-pad-top-24">
						...
						<!--<div id="dealer_pg" class="stm-accordion-single-unit stm-listing-directory-checkboxes stm-one_col stm-ajax-checkbox-instant service-categories">
						<a class="title <?php echo $dealercategory; ?>" data-toggle="collapse" href="#accordion-dealerships-category" aria-expanded="false">
							<h5><img src="<?php echo get_home_url(); ?>/wp-content/uploads/2021/09/service-category.png" class="sidebar-icons"> Service Categories</h5>
							<span class="minus"></span>
						</a>
						<div class="stm-accordion-content">
							<div class="collapse content <?php echo $dealercategory2;?>" id="accordion-dealerships-category">
						...
						<!--<div class="stm-accordion-single-unit stm-listing-directory-checkboxes stm-one_col stm-ajax-checkbox-instant parts-accessories">
						<a class="title <?php echo $dealerparts; ?>" data-toggle="collapse" href="#accordion-dealerships-parts" aria-expanded="false">
							<h5><img src="<?php echo get_home_url(); ?>/wp-content/uploads/2021/09/parts-and-accessories.png" class="sidebar-icons"> Parts and Accessories</h5>
							<span class="minus"></span>
						</a>
						<div class="stm-accordion-content">
										   ...
										   <div class="stm-keyword-search-unit" style="clear: both;">
					                            <?php foreach($parts_terms as $parts) {?>
					                              <label class="stm-option-label" style="display: block;">
					                                ...
					                                value="<?php echo $parts->name; ?>" <?php if( !empty($_GET['service_parts']) && in_array($parts->name, $_GET['service_parts']) ){ echo " checked=checked "; } ?> />
...
<!--<form  method="get" action="/dealers-list/" id="dealershipsresetofworld" class="dealershipsresetofworld">
	
		<div class="stm-accordion-single-unit stm-listing-directory-checkboxes stm-one_col stm-ajax-checkbox-instant">
		<a class="restworld title  <?php echo $first; ?>" data-toggle="collapse" href="#accordion-region" aria-expanded="false">
			<h5><i class="fas fa-globe-americas"></i> Rest of the world:</h5>
			<span class="minus"></span>
		</a>
		<div class="stm-accordion-content">
			<div class="collapse <?php echo $second; ?> content 777" id="accordion-region">
				<div class="stm-accordion-content-wrapper stm-accordion-content-padded">
					<div class="stm-accordion-inner">
						<div class="tree_main">
		...
		<br/>
			...
			<?php  echo do_shortcode('[widget id="custom_html-7"]'); ?>
       ...
       <!-- <div>
            <div class="filter filter-sidebar">
                    <div class="row row-pad-top-24">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="clearfix" >
                                <h4 class="pull-left " style="text-transform: uppercase;">Add your business listing</h4>
                                <div class="clearfix" style="clear: both;">
                                    We appreciate you taking the time today to visit our web site. Our goal is to give you an interactive tour of our new and used inventory, as well as allow you to conveniently get a quote, schedule a service appointment, or apply for financing.<br/>
                                    <a href="https://hd-central.com/service-provider-listings/">Add your business listing</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="99900 col-md-9 col-sm-12 <?php echo esc_attr($sidebar_pos['content']); ?>">
...
<div id="listings-result" style="margin-top: 25px;">
		...
		<div id="listings-result">
			...
			if(!empty($_GET['ca_keywords'])){
				$_GET['business_name'] = $_GET['ca_keywords'];
			}
...
<script type="text/javascript">
	...
	var Markers = {};
	var infowindow;
	console.log(<?php echo $locations ;?>);
	var locations = [
