...
<div class="stm-user-private">
    <div class="container-fluid p-0">
        <div class="d-flex">
            ...
            <div class=" hidden-sm hidden-xs stm-sticky-user-sidebar stm-usersidebar-left">
                <div class="dashboard_menu">Dashboard Menu</div>
                <div class="stm-user-private-sidebar">
                    ...
                    <div class="clearfix stm-user-top">
                        ...
                        <div class="stm-user-avatar">
                            <a href="<?php echo esc_url($link); ?>"
                                ...
                                <img class="img-responsive img-avatar"
                                    src="<?php echo (!empty(get_user_meta($user->ID, 'wsl_current_user_image', true))) ? esc_url(get_user_meta($user->ID, 'wsl_current_user_image', true)) : esc_url($user_fields['image']); ?>" />
                        ...
                        <div class="stm-user-profile-information">
                            ...
                            <div class="title-sub"><?php 
							echo get_user_meta($user->ID, 'user_type', true);

							//esc_html_e('Personal Subscriber', 'motors'); ?></div>

                            <?php /* ?><?php if(!empty($user_fields['socials'])): ?>
                    ...
                    <div class="stm-dealer-phone">
                        ...
                        <div class="phone-label heading-font"><?php esc_html_e('Subscriber Contact Phone', 'motors'); ?>
                        </div>
                    ...
                    <div class="stm-dealer-mail">
                        ...
                        <div class="mail-label heading-font"><?php esc_html_e('Subscriber Email', 'motors'); ?></div>
                    ...
                    <?php /* ?><?php if($user_type == 'Business Subscriber'){ ?>
                    <div class="stm-user-current-plan-info heading-font">
                        ...
                        <div class="stm-plan-name">
                            <?php echo stm_do_lmth($stm_user_active_subscriptions['plan_name']); ?></div>
                        ...
                        jQuery(document).ready(function() {
                            ...
                            $(".stm-start-countdown")
                                .countdown(
                                    "<?php echo stm_do_lmth($stm_user_active_subscriptions['expires']); ?>",
                                    function(event) {
                                        $(this).text(
