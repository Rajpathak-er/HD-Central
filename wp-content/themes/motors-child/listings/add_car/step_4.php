<?php if(empty($id)):?>
    <div class="stm-form-4-videos clearfix">
        <div class="stm-car-listing-data-single stm-border-top-unit">
            <div class="title heading-font" style="display: none;"><?php esc_html_e('Add Videos', 'motors'); ?></div>
            <span class="step_number step_number_4 heading-font" style="display: none;"><?php esc_html_e('step', 'motors'); ?> 5</span>
        </div>
