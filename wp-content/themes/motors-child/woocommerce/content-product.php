...
<li <?php post_class( $classes ); ?>>
	...
	<div class="stm-product-inner">
		...
		<div class="product_thumbnail 123">
			...
			<?php
				...
				if($product_type  == 'ebay'){
                    ...
                    $featured_image_url =  $car_gallery;

					
					if($featured_image_url){
						echo '<img width="140" height="79" src="'.$featured_image_url.'" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" srcset="" sizes="">';
					}
				}
			?>
			...
			<!--<a href="<?php /*the_permalink(); */?>">-->
                ...
                $_amzaff_prodtype = get_post_meta(get_the_ID(),'_amzaff_prodtype',true);
				//echo "++++".$_amzaff_prodtype;
                if($_amzaff_prodtype  == 'ebay'){
                    $car_gallery = get_post_meta( get_the_ID(), 'gallery', true );
                    
                    //$_thumbnail_id =  get_post_meta(get_the_ID(),'_thumbnail_id',true);
                    $product_thumbnail_url =  $car_gallery[0];
                    ?>
                    <img width="299" height="169" src="<?php echo $product_thumbnail_url;?>" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail wp-post-image" alt="">
                    <?php
                }
				?>
			<!--</a>-->
