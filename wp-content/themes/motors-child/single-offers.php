...
$images = get_field('offer_image', get_the_ID()); 
$event_desc = get_the_content();
$event_desc = get_field('offer_details', get_the_ID());
$category_event = get_field('offer_category');
$additional_details = get_field('additional_details');
$start_date = get_field('offer_end_date');
				...
				<?php if (!empty($event_desc)) : ?>
					<div class="stm-section stm-dealer-desc-section">
						<div class="stm-description">
							<div class="heading-title"><?php esc_html_e('Offers Details', 'motors'); ?></div>
							<?php
								echo $event_desc; ?>
						</div>
					</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<div class="stm-label service_category heading-title"><?php esc_html_e('Offers Categories', 'motors'); ?></div>
										<?php
										foreach ($category_event as  $category) {
										?>
											<div class="col-md-3 col-sm-3 col-xs-6">
												<label>
													<span class="service_data_single"><?php echo get_term( $category )->name; ?></span>
												</label>
											</div>
										<?php
										}
					...
					<div class="stm-block stm-event-date-block">
						<div class="stm-dealer-info-unit event-date">
							<div class="heading-title">
								...
								<span><?php esc_html_e('Offer End Date', 'motors'); ?></span>
							</div>
							<div class="inner">
